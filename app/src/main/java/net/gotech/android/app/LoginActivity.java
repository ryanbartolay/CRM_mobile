...
import com.example.rbartolay.myapplication.MasterActivity;
...
//            });
            if(show) {
                mUsernameView.setActivated(false);
                mPasswordView.setActivated(false);
                mLoginButton.setActivated(false);
                mLoginButton.setText(R.string.action_logging_in);
            } else {
                mUsernameView.setActivated(true);
        ...
        protected JSONObject doInBackground(String... args) {
            try {
                ...
                JSONObject json = jsonParser.makeHttpRequest(
                        Constants.LOGIN_URL, "POST", params);

                if (json != null) {
                    System.out.print("aaaaa " + json.toString());
...
//            return true;
        ...
        @Override
        protected void onPostExecute(final JSONObject credentials) {
            mAuthTask = null;
            showProgress(false);
            ...
            if(credentials != null) {
                ...
                String message = "";
                try {
                    result = credentials.getString("login_result");
                    message = credentials.getString("message");
                ...
                mPasswordView.setError(getString(R.string.error_server_no_response));
                mErrorView.setVisibility(View.VISIBLE);
            }
        }
